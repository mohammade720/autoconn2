    ...
    child: Card(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 16),
          Column(
            children: product.requestedItems.map((item) => buildPartItemTile(context,item)).toList(),
          ),
        ],
      ),
    ),
...
Widget buildPartItemTile( BuildContext context, PartItem item) {
  return Padding(
    padding: const EdgeInsets.symmetric(horizontal: 16),
    child: Column(
      children: [
        Row(
          children: [
            ...
            const Spacer(),
            Text(item.status, style: Theme.of(context).textTheme.labelSmall?.copyWith(color: const Color(0xFFEAB308))),
          ],
        ),
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: [
                            const Icon(Symbols.directions_car,
